...
{
  "relationships": [
      { "source": "Name of source", "target": "Name of target", "type": "Nature of their relationship"},
      { "source": "Name of source", "target": "Name of target", "type": "Nature of their relationship"}      
  ]
}
"""
    ...
    def extract_relationships(self, context: str) -> List[Dict[str, str]]:
        ...
        try:
            ...
            if results:
                ...
                relationships = data.get("relationships", False) or data.get("properties", {}).get("relationships", [])
